...
export default function DishCard({
  ...
  const handleAdd = () => {
    addToCart({ id, name, price, image, date, day});
  };
  ...
  return (
    <div className="relative flex flex-col items-center w-[300px] transition duration-300 transform hover:scale-105">
      ...
      <div className="w-full bg-[#ffffff] rounded-[40px] h-[240px] w-[240px] drop-shadow-md px-5 pt-6 pb-4 relative">
